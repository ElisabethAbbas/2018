...
public class TasMinArbreBinaire{
	...
	public static TasMinArbreBinaire union(TasMinArbreBinaire u, TasMinArbreBinaire v) {
		...
		while(!priority.isEmpty()) {
			...
			}while(trees.contains(tmp) && !priority.isEmpty());
	...
	public TasMinArbreBinaire lastNode(){
		TasMinArbreBinaire lastNode=this;
		int n=(int)Math.floor(Math.log(this.getNumberOfKeys())/Math.log(2));
		int i=n;
		int tmp=numberOfKeys;
	...
	public static void swap(TasMinArbreBinaire a, TasMinArbreBinaire b) {
		Key tmp=a.getKey();
		a.setKey(b.getKey());
		b.setKey(tmp);
	}
	...
	public String toString() {
		String s = ""+key.getKey().toString(16) + 
				" fg : " + 
				((haveLeftChild())?getLeftChild().getKey().getKey().toString(16):"none") + 
				" fd : "+ 
				((haveRightChild())?getRightChild().getKey().getKey().toString(16):"none");
		s+="\n";
